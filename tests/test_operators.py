...
def test_sigmoid(a: float, b: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert is_close(b, 0.0) or sigmoid(a) < sigmoid(a + abs(b)) or is_close(sigmoid(a), 0.0) or is_close(sigmoid(a), 1.0)
...
def test_transitive(a: float, b: float, c: float) -> None:
    ...
    # TODO: Implement for Task 0.2.
    assert is_close(lt(a, b) and lt(b, c), lt(a, c)) or is_close(lt(a, b) and lt(b, c), 0.0)
